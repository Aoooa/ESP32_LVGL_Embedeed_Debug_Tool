...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 801, .adv_w = 336, .box_w = 21, .box_h = 29, .ofs_x = 0, .ofs_y = -4}
};
...
{
    {
        .range_start = 61485, .range_length = 1942, .glyph_id_start = 1,
